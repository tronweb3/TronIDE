...
module.exports = {
  ...
  'Should Search for plugins': function (browser: NightwatchBrowser) {
    browser.waitForElementVisible('*[data-id="pluginManagerComponentPluginManager"]')
      .setPluginSearch('debugger')
      .waitForElementVisible('#remixPluginManagerListItem_debugger')
      .setPluginSearch('restore')
      .waitForElementVisible('#remixPluginManagerListItem_restorebackupzip')
      .setPluginSearch('')
  },
  ...
  'Should activate plugins': function (browser: NightwatchBrowser) {
    browser.waitForElementVisible('*[data-id="pluginManagerComponentPluginManager"]')
      ...
      .waitForElementVisible('*[data-id="pluginManagerComponentDeactivateButtonrestorebackupzip"]', 60000)
  },
  ...
  'Should deactivate plugins': function (browser: NightwatchBrowser) {
    browser.waitForElementVisible('*[data-id="pluginManagerComponentPluginManager"]')
      ...
      .waitForElementVisible('*[data-id="pluginManagerComponentDeactivateButtondebugger"]', 60000)
      .pause(2000)
      .clickIfPresent('*[data-id="pluginManagerComponentDeactivateButtondebugger"]')
      .waitForElementVisible('*[data-id="pluginManagerComponentActivateButtondebugger"]', 60000)
      .waitForElementVisible('*[data-id="pluginManagerComponentDeactivateButtonrestorebackupzip"]', 60000)
      .clickIfPresent('*[data-id="pluginManagerComponentDeactivateButtonrestorebackupzip"]')
      .waitForElementVisible('*[data-id="pluginManagerComponentActivateButtonrestorebackupzip"]', 60000)
  },
