...
declare module "nightwatch" {
    export interface NightwatchCustomCommands {
        ...
        focusWorkspaceRoot(): NightwatchBrowser,
        ...
        checkVariableDebugSubset(id: string, debugValue: NightwatchCheckVariableDebugValue): NightwatchBrowser,
        ...
        selectWorkspace(name: string): NightwatchBrowser
    }
