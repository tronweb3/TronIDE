...
you get stuck using Remix. Please, join [the community](https://github.com/tronweb3/TronIDE/issues) and ask for help.

For anyone who is interested in developing a custom plugin for Remix or who wants to contribute to the codebase,
we opened a [contributors' channel](https://github.com/tronweb3/TronIDE/issues) especially for developers working on Remix tools.
