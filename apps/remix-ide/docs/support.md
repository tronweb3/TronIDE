...
you get stuck using Remix. Please, join [the Remix channel](https://github.com/tronweb3/TronIDE/issues) and ask the community for help.

For anyone who is interested in developing a custom plugin for Remix or who wants to contribute to the codebase,
we've opened [another channel](https://github.com/tronweb3/TronIDE/issues) specially for developers working on Remix tool.
