...
module.exports = class TestTab extends ViewPlugin {
  ...
  */
  ...
  infoButton () {
    return yo`
      <a class="btn border text-decoration-none pr-0 d-flex w-50 ml-2" title="Check out documentation." target="_blank" rel="noopener noreferrer" href="https://remix-ide.readthedocs.io/en/latest/unittesting.html#test-directory">
