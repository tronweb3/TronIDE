...
export default class HardhatProvider extends Plugin {
  ...
  hardhatProviderDialogBody () {
    return yo`
        ...
        <br>
        For more info, visit: <a href="https://hardhat.org/getting-started/#connecting-a-wallet-or-dapp-to-hardhat-network" target="_blank" rel="noopener noreferrer">Hardhat Documentation</a>
        <br><br>
