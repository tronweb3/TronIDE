...
tape('ContractArrayParameters - (TxFormat.buildData) - format array input parameters', function (t) {
  ...
  t.test('(TxFormat.buildData)', function (st) {
    ...
    testWithArrayInput(st, '[true, false, true], [0xf7a10e525d4b168f45f74db1b61f63d3e7619ea8, 0xf7a10e525d4b168f45f74db1b61f63d3e7619ea8], ["0x0c5d9661b4fb92eb7472f28510ea68d4f369c8fe57b3ed4c2e8dfa4e79e549fd", "0x0c5d9661b4fb92eb7472f28510ea68d4f369c8fe57b3ed4c2e8dfa4e79e549fd"], [90071992547409910000, 34, 45], "itsremix"', '')
  })
})
...
tape('findUnsafeIntegerLiteralParams identifies unsafe bare integer literals without flagging quoted values or addresses', function (t) {
  t.plan(5)

  let findings = txFormat.findUnsafeIntegerLiteralParams('9007199254740992', [{ name: 'initial_value', type: 'uint256' }])
  t.equal(findings.length, 1)
  t.equal(findings[0].name, 'initial_value')
  t.equal(findings[0].value, '9007199254740992')

  findings = txFormat.findUnsafeIntegerLiteralParams('"9007199254740992"', [{ name: 'initial_value', type: 'uint256' }])
  t.equal(findings.length, 0, 'quoted unsafe integers should not be blocked')

  findings = txFormat.findUnsafeIntegerLiteralParams('0xf7a10e525d4b168f45f74db1b61f63d3e7619ea8', [{ name: 'recipient', type: 'address' }])
  t.equal(findings.length, 0, 'address inputs should not be treated as unsafe integers')
})
...
tape('test abiEncoderV2 array of tuple', function (t) {
  t.test('(abiEncoderV2)', function (st) {
    ...
    */
    ...
    txFormat.encodeParams('[[90071992547409910000, "test"], [123, "test2"]]', contract.abi[2], (error, encoded) => {
      console.log(error)
      const decoded = txFormat.decodeResponse(hexToIntArray(encoded.dataHex), contract.abi[2])
      console.log(decoded)
      st.equal(decoded[0], 'tuple(uint256,string)[]: strucmts 90071992547409910000,test,123,test2')
    })
  })
})
