    ...
    sendTx(vm, { nonce: 0, privateKey: privateKey }, null, 0, contractBytecode, function (error, data) {
      ...
      vm.web3.eth.getTransaction(txHash, function (error, tx) {
        ...
        callTree.event.register('callTreeReady', (scopes, scopeStarts) => {
          try {
            const functions1 = callTree.retrieveFunctionsStack(116)
            const functions2 = callTree.retrieveFunctionsStack(129)
            const functions3 = callTree.retrieveFunctionsStack(27)
