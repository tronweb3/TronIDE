...
export { parseRemappings } from './compiler/remappings'
...
export { promisedMiniXhr, pathToURL, pathToIntegrity, baseURLBin, baseURLWasm, baseURLTron, tronCompilerSourceProvider, canUseWorker, urlFromVersion, integrityFromCompilerURL, compilerIntegrityToSRI, compilerSourceMockMode, maybeMockCompilerSourceURL, assertAllowedCompilerURL, ALLOWED_COMPILER_ORIGINS, BUILTIN_SOLC_VERSION } from './compiler/compiler-utils'
