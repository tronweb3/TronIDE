...
export const ContractSelection = (props: ContractSelectionProps) => {
  ...
  const copyContractProperty = (property) => {
    ...
    } catch (e) { console.warn('[contract-selection] failed to stringify content', e) }
  ...
  const getContractProperty = (property) => {
    ...
    if (contractProperties && contractProperties[property]) return (property === 'bytecode' ? contractProperties.bytecode.object : contractProperties[property])
    return null
  }
