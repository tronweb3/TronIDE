...
export const gitAccessTokenText2 = 'Go to github token page (link below) to create a new token and save it in TronIDE. Make sure this token has only \'create gist\' permission.'
